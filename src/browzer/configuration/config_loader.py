...
from browzer.helpers.operating_system.environ import read_from_environ, get_dictionary_from_yaml
from browzer.constants.strings import BROWSER_BINARY_PATH, CSS
...
class ConfigLoader:
    ...
    def build_config(self) -> BrowzerConfiguration:
        return BrowzerConfiguration(**self.configuration_container.get_config_merged_dictionary())
...
class ConfigurationYamlContainer:
    ...
    def __init__(self):
        ...
        self.browzer_cfg_path: str = os.path.join(os.path.dirname(__file__), "default_configuration.yaml")
